...
import {useInquiryListQuery} from '../../generated/graphql';
...
const InquiryContainer = ({ logged_in,user_name,user_graph_id }: Props) => {
    const [search_string, set_search_string] = useState('');
    const [filter_term, set_filter_term] = useState('');
    const { data, error, loading, refetch } = useInquiryListQuery(
    ...
    return (
        <Fragment>
            <div className={`${className}__Container`}>
                ...
                <Inquiry data={data} filter_term={filter_term}
