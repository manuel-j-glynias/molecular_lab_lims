...
import { EditableFloatQuery } from '../../../generated/graphql'
import './styles.css'


export interface Props {
    data: EditableFloatQuery;
}
...
const EditableFloatHistory: React.FC<Props> = ({data}) => (

    <div className={className}>
        <h3>History</h3>
        <ol className={`${className}__list`}>
            {!!data.EditableFloat &&
            data.EditableFloat.map(
                (ES, i: string | number ) =>
                    !!ES && (
...
export default EditableFloatHistory;