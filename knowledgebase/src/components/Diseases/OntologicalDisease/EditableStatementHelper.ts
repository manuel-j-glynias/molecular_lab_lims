...
/*export const get_synonym_mutation_object = (ontodiseaseID:string, oldESID:string, esField:string, synonyms:string[], userID:string): AddSynonymsMutationVariables=> {
...
/*export const get_category_mutation_object = (ontodiseaseID:string, oldESID:string, esField:string, category:string, userID:string, refs_array:Array<string>): AddOmniGeneOncogenicCategoryMutationVariables=> {
...
export const get_description_mutation_object = (ontodiseaseID:string, oldESID:string, esField:string, description:string, userID:string, refs_array:Array<string>): AddOntologicalDiseaseDescriptionMutationVariables=> {
    ...
    const  variables :AddOntologicalDiseaseDescriptionMutationVariables = {
        id:ontodiseaseID,
        old_es_id:oldESID,
        date: get_date_as_hyphenated_string(),
        es_field: esField,
