...
import {useProteinExpressionMarkerAddResultsMutation} from "../../../generated/graphql";
...
const ResultsEditableStatementEditor : React.FC<Props> = ({statement,set_editing,es_ID, es_field,marker_id,ref_array,refetch}) => {
    ...
    const [addResultsMutation, { loading: mutationLoading, error: mutationError, data:mutationData }] = useProteinExpressionMarkerAddResultsMutation({variables:{marker_id:'', old_es_id:'',
