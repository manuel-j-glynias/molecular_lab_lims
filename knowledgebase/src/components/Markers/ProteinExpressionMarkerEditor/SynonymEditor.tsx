...
import {get_editable_synonym_mutation_object} from "../../common/Helpers/EditableStatementHelper"
import {useProteinExpressionMarkerAddSynonymsMutation} from "../../../generated/graphql";
...
const SynonymEditor: React.FC<Props> = ({synonym_string, set_editing, es_ID, es_field,marker_id,refetch}) => {
    ...
    const [addSynonymStringMutation, { loading: mutationLoading, error: mutationError, data:mutationData }] = useProteinExpressionMarkerAddSynonymsMutation({variables:{marker_id:'', old_esyn_id:'',
    ...
    const save = async () => {
        ...
        const mutation_object = get_editable_synonym_mutation_object(marker_id,es_ID,es_field,synonyms,user_ID);
