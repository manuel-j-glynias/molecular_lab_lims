...
const MarkerContentContainer : React.FC<Props> = ({markerType,variant_id,editing_description,editing_protein_effect,editing_components,set_editing_components,
                                                      // selected_component,
                                                      set_selected_component,set_markerType,set_query_string,set_marker_id,selected_gene_label}) => {
    return (<Fragment>
        ...
        { (markerType=="NewMarker") && <NewMarker set_markerType={set_markerType} set_query_string={set_query_string} set_marker_id={set_marker_id}/>}
            </Fragment>)
