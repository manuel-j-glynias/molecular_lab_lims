...
import {useMsiMarkerAddMethodMutation} from "../../../generated/graphql";
...
const MethodEditableStatementEditor : React.FC<Props> = ({statement,set_editing,es_ID, es_field,marker_id,ref_array,refetch}) => {
    ...
    const [addMethodMutation, { loading: mutationLoading, error: mutationError, data:mutationData }] = useMsiMarkerAddMethodMutation({variables:{marker_id:'', old_es_id:'',
