...
import {VariantProteinEffect,useVariantSnvIndelAddProteinEffectMutation} from "../../../generated/graphql";
...
const ProteinEffectEditor : React.FC<Props> = ({protein_effect, set_editing, epe_ID, epe_field,variant_ID,ref_array,refetch}) => {
    ...
    const [addProteinEffectMutation, { loading: mutationLoading, error: mutationError, data:mutationData }] = useVariantSnvIndelAddProteinEffectMutation({variables:{variant_id:'', old_epe_id:'',
