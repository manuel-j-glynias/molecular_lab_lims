...
import {useVariantSnvIndelAddDescriptionMutation} from "../../../generated/graphql";
...
const DescriptionEditor : React.FC<Props> = ({description,set_editing,es_ID, es_field,variant_ID,refetch}) => {
    ...
    const [addDescriptionMutation, { loading: mutationLoading, error: mutationError, data:mutationData }] = useVariantSnvIndelAddDescriptionMutation({variables:{variant_id:'', old_es_id:'',
