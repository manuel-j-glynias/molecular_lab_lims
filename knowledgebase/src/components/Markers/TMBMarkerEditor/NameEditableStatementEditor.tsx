...
import {useTmbMarkerAddNameMutation} from "../../../generated/graphql";
...
const NameEditableStatementEditor : React.FC<Props> = ({statement,set_editing,es_ID, es_field,marker_id,ref_array,refetch}) => {
    ...
    const [addNameMutation, { loading: mutationLoading, error: mutationError, data:mutationData }] = useTmbMarkerAddNameMutation({variables:{marker_id:'', old_es_id:'',
