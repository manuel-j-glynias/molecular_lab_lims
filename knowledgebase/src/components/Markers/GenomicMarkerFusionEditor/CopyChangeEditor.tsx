...
import {CnvType, useVariantFusionAddCopyChangeMutation} from "../../../generated/graphql";
...
const CopyChangeEditor : React.FC<Props> = ({copyChange, set_editing, id, field,variant_ID,ref_array,refetch}) => {
    ...
    const [addCopyChangeMutation, { loading: mutationLoading, error: mutationError, data:mutationData }] = useVariantFusionAddCopyChangeMutation({variables:{variant_id:'', old_id:'',
