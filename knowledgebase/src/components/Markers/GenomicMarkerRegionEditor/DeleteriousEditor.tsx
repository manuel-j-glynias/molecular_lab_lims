...
import {EditableBoolean,ExtendedBoolean,useVariantRegionAddIsDeleteriousMutation} from "../../../generated/graphql";
...
const DeleteriousEditor : React.FC<Props> = ({isDeleterious, id,field,variant_ID,ref_array,set_editing,refetch}) => {
    ...
    const [addIsDeleteriousMutation, { loading: mutationLoading, error: mutationError, data:mutationData }] = useVariantRegionAddIsDeleteriousMutation({variables:{variant_id:'',  old_eb_id:'',
    ...
    async function extracted(refs: string[]) {
        ...
        await addIsDeleteriousMutation({variables: mutation_object})
    }
    ...
    const state  = {
        selectedOption: { value: isDeleterious, label: get_label_for_value(isDeleterious) },
    };
...
export default DeleteriousEditor;